...
from configapp.views import TeacherCreateApi, DepartmentAPI, CourseAPI, AddGroupAPI, StudentDetailApi, RoomsAPI, \
    TableTypeAPI, AddTableAPI, SendEmailAPI, StudentChangePassword, LoginUser
